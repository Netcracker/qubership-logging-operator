...
- **Stage 2** — complete migration (move data out of `{}` / `log.*f` / bracket text into structured fields,
  inventories, semantic gates): apply `qubership-ndjson-logging-migrate` after stage 1 is done or explicitly scoped.
