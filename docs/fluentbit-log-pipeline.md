...
| 33  | filters/filter-nonsupported-levels.conf       | FILTER lua (Script /fluent-bit/etc/update_level_syslog.lua)                           | Excludes built-in HTTP routing tags       | Converts the value of the `level` field to FluentBit supported severity levels                                                                                                                                               |
