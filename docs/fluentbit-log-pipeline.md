...
| 17  | filters/filter-validate.conf                  | FILTER lua (Call kv_parse)                                                            | Match pods*                                  | Parses [key=value] labels in `log` only when `qubership_candidate` exists                                                                                                                                                    |
...
| 28  | filters/filter-post-generic.conf              | FILTER lua (Call kv_parse)                                                            | Match pods*                                  | Parses [key=value] labels in `log` only when `qubership_candidate` exists                                                                                                                                                    |
...
| 33  | filters/filter-post-generic.conf              | FILTER modify (Set parse_format qubership)                                            | Match_regex (pods\|klog).*                   | Classifies records that contain `qubership_candidate` as Qubership logs                                                                                                                                                      |
...
| 36  | filters/filter-post-generic.conf              | FILTER record_modifier (Remove_key temporary and raw-log fields)                      | Match_regex (pods\|klog).*                   | Removes `orig_field_count`, `log`, `original_log`, `logfmt_candidate`, and `qubership_candidate`                                                                                                                             |
