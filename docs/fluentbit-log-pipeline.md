...
| 35  | filters/filter-post-generic.conf              | FILTER modify (Set parse_format qubership)                                            | Match_regex (pods\|klog).*                   | Classifies records that contain `__qubership_candidate` as Qubership logs                                                                                                                                                    |
| 36  | filters/filter-post-generic.conf              | FILTER modify (Set short_message `<Empty message>`)                                   | Match_regex (pods\|klog).*                   | Adds a placeholder when a Qubership record has no `short_message`                                                                                                                                                            |
