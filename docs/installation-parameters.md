...
| `multilineOtherLinesRegexp`       | string                                                                                                                            | no        | `/^(?!\\[\\d{4}\\-\\d{2}\\-\\d{2}\|\\s*\\{).*/`                                                 | Custom regular expression for the other lines of multiline filter                                                                                                                        |
...
fluentbit:
  ...
  multilineOtherLinesRegexp: "/^(?!\\[\\d{4}\\-\\d{2}\\-\\d{2}|\\s*\\{).*/"
  billCycleConf: true
