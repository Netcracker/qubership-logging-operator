...
| `output.http.uri`                 | string                                                                                                                            | no        | `/insert/jsonline?_stream_fields=namespace,container&_msg_field=short_message&_time_field=date` | HTTP URI for the target web server                                                                                                                                                       |
  ...
  aggregator:
    ...
    output:
      http:
        ...
        host: vlsingle-k8s.victorialogs
        port: 9428
        uri: /insert/jsonline?_stream_fields=stream&_msg_field=short_message&_time_field=date
        auth:
          token:
            name: http-secret
            key: token
