...
| `output.http.host`                | string                                                                                                                            | no        | `-`                                                                              | Http host. Example: http://10.10.10.10:9428 or https://vlsingle-k8s.victorialogs:9428                                                                                                                                                                                                                  |
...
| `output.http.headers`             | json                                                                                                                            | no        | `{"VL-Msg-Field": "log", "VL-Time-Field": "time", "VL-Stream-Fields": "stream"}` | Additional headers for HTTP output.                                                                                                                                                                                                                                                                    |
