...
| `db.enabled`                      | boolean                                                                                                                           | no        | `true`                                                                                          | Enables the SQLite database where the input plugins keep the position of the read files. Disabling it removes the database writes, but FluentBit loses the read offsets on the restart.  |
