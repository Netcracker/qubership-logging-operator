...
For authenticated Loki, HTTP, or OpenTelemetry output, set `configSecret` to a Secret key that contains the complete
...
| `output.loki.configSecret`       | map                                                                                                                               | no        | `-`                                                                                             | Secret reference with `secretName` and `secretKey`; the key must contain the complete Fluent Bit Loki `[OUTPUT]` section                                                                 |
...
| `output.http.configSecret`       | map                                                                                                                               | no        | `-`                                                                                             | Secret reference with `secretName` and `secretKey`; the key must contain the complete Fluent Bit HTTP `[OUTPUT]` section                                                                 |
...
| `output.otel.configSecret`       | map                                                                                                                               | no        | `-`                                                                                             | Secret reference with `secretName` and `secretKey`; the key must contain the complete Fluent Bit OpenTelemetry `[OUTPUT]` section                                                        |
